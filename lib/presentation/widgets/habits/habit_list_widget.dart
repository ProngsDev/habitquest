...
class TodaysHabitsWidget extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) =>
      const HabitListWidget(physics: AlwaysScrollableScrollPhysics());
}

/// Widget for displaying habits in a specific category
class CategoryHabitsWidget extends ConsumerWidget {
  const CategoryHabitsWidget({required this.category, super.key});
  final String category;

  @override
  Widget build(BuildContext context, WidgetRef ref) =>
      HabitListWidget(categoryFilter: category);
}

/// Widget for displaying search results
class HabitSearchResultsWidget extends ConsumerWidget {
  const HabitSearchResultsWidget({required this.searchQuery, super.key});
  final String searchQuery;

  @override
  Widget build(BuildContext context, WidgetRef ref) => HabitListWidget(
