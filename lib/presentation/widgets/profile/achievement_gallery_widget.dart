...
class AchievementGalleryWidget extends StatelessWidget {
  const AchievementGalleryWidget({required this.achievements, super.key});
  ...
  Widget _buildAchievementGrid() => GridView.builder(
    shrinkWrap: true,
  ...
  Widget _buildAchievementCard(Achievement achievement) => DecoratedBox(
    decoration: BoxDecoration(
      color: Color(achievement.rarity.colorValue).withValues(alpha: 0.1),
      borderRadius: BorderRadius.circular(12),
      border: Border.all(
        color: Color(achievement.rarity.colorValue).withValues(alpha: 0.3),
        width: 2,
      ),
    ),
    child: Column(
