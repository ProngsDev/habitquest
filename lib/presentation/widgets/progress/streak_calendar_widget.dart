...
class StreakCalendarWidget extends StatelessWidget {
  ...
  Widget _buildCalendarGrid(
    ...
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: weeks
          .map((week) => _buildWeekColumn(week, heatmapData))
          .toList(),
    );
  }
  ...
  Widget _buildDayCell(DateTime date, int completionCount) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isToday ? Border.all(color: CupertinoColors.systemBlue) : null,
      ),
  ...
  Color _getIntensityColor(double intensity) {
    ...
    const baseColor = CupertinoColors.systemGreen;
    return Color.lerp(baseColor.withOpacity(0.2), baseColor, intensity)!;
  }
