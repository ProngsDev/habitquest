...
class LevelProgressWidget extends StatelessWidget {
  ...
  Widget _buildLevelInfo(BuildContext context) => Container(
    padding: const EdgeInsets.all(12),
    decoration: BoxDecoration(
      color: AppTheme.getLevelColor(currentLevel).withValues(alpha: 0.1),
      borderRadius: BorderRadius.circular(8),
      border: Border.all(
        color: AppTheme.getLevelColor(currentLevel).withValues(alpha: 0.3),
      ),
    ),
    child: Row(
      children: [
